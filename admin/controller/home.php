...
class home extends Controller {
	...
	public function index(){
		...
		// pr($data);
		$listBerita = $this->listBerita();
		$listGallery = $this->informasi_gallery();
		$data['listBerita'] = $listBerita;
	...
	{
		$data['notif'] = $this->contentHelper->getNotif($_SESSION['user']['id']);
		
		return $this->loadView('notif',$data);
	}

		<script type="text/javascript" charset="utf-8">
			...
			oSettings.fnServerData.call( oSettings.oInstance, oSettings.sAjaxSource, aData, function(json) {
				...
				$('#agendatable').dataTable({
					...
					"bProcessing": true,
					"bServerSide": true,
					"sAjaxSource": "datatables_api/server_processing_agenda",
					...
					oTable= $('#agendatable').dataTable();
					oTable.fnReloadAjax("datatables_api/server_processing_agenda/?category='9'&articletype='1'");
			} );
		</script>

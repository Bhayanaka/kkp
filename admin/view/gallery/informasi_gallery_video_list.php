			...
			oSettings.fnServerData.call( oSettings.oInstance, oSettings.sAjaxSource, aData, function(json) {
				...
				$('#opinitable').dataTable({
					...
					"bProcessing": true,
					"bServerSide": true,
					"sAjaxSource": "datatables_api/server_processing_galleryVideo",
					...
					oTable.fnReloadAjax("../datatables_api/server_processing_galleryVideo/?category='7'&articletype='2'");
			} );
		</script>
				...
				echo "&nbsp;";
				?>
				<table class="table table-striped" id="opinitable">
					<thead>
					<tr>
						<th>No</th>

				...
				<a class="sub_menu_in" href="http://localhost/tataruang/admin/onemap/dbtematik_view">Database Tematik</a>
				<a class="sub_menu_in" href="http://localhost/tataruang/admin/onemap/indeksPeta_view">Indeks Peta Tematik</a>
				<a class="sub_menu_in on" href="http://localhost/tataruang/admin/onemap/dbspasial_view">Database Spasial</a>
				<br />
				<br />
				<h4 class="title_sub_menu_in">List Database Spasial</h4>
				<?php 
				if($_SESSION['user']['usertype'] == '1' || $_SESSION['user']['usertype'] == '2' || $_SESSION['user']['usertype'] == '3' ){
				?>
				<div class="row-fluid" >
					<div class="span6"><a href="<?=$basedomain?>onemap/add_dbspasial" class="btn btn-primary">Tambah Data</a></div>
				</div>
				<?php
				}
				?>
				...
				<table class="table table-striped" id="tableajax">
					...
					<tr>
						...
						<td><?php
							...
							?>
								<a href="status_dbspasial/?id=<?php echo $val['id'];?>&status_dbspasial=<?php echo $val['n_status'];?>" class="icon-globe" title="Publish"></a>&nbsp;&nbsp;&nbsp;
								<a href="add_dbspasial/?id=<?php echo $val['id'];?>" class="icon-edit" title="Edit"></a>&nbsp;&nbsp;&nbsp; 
								<a href="del_dbspasial/?id=<?php echo $val['id'];?>" class="icon-trash" title="Hapus" onclick="return confirm('Hapus Data');"></a>

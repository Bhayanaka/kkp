			...
			oSettings.fnServerData.call( oSettings.oInstance, oSettings.sAjaxSource, aData, function(json) {
				...
				$('#dbSpasialTable').dataTable({
					...
					"bProcessing": true,
					"bServerSide": true,
					"sAjaxSource": "../datatables_api/server_processing_dbSpasial",
					...
					oTable= $('#dbSpasialTable').dataTable();
					oTable.fnReloadAjax("../datatables_api/server_processing_dbSpasial/?category='16'&articletype='4'");
			} );
		</script>
				...
				<a class="sub_menu_in on" href="<?php $basedomain?>dbspasial_view">Database Spasial</a>
				<br />
				<br />
				...
				?>
				<br />
				<table class="table table-striped" id="dbSpasialTable">
					<thead>
					<tr>
						<th>No</th>

		<script type="text/javascript" charset="utf-8">
			...
			oSettings.fnServerData.call( oSettings.oInstance, oSettings.sAjaxSource, aData, function(json) {
				...
				$('#opinitable').dataTable({
					...
					"bProcessing": true,
					"bServerSide": true,
					"sAjaxSource": "datatables_api/server_processing_opini",
					...
					oTable= $('#opinitable').dataTable();
					oTable.fnReloadAjax("datatables_api/server_processing_opini/?category='5'&articletype='1'");
			} );
		</script>
		<div class="laper3"></div>
				...
				echo "&nbsp;";
				?>
				<table class="table table-striped table-hover" id="opinitable">
				<thead>
					<tr>
						<th>No</th>

			...
			oSettings.fnServerData.call( oSettings.oInstance, oSettings.sAjaxSource, aData, function(json) {
				...
				$('#produkTable').dataTable({
					...
					"bProcessing": true,
					"bServerSide": true,
					"sAjaxSource": "../datatables_api/server_processing_norma",
					...
					oTable.fnReloadAjax("../datatables_api/server_processing_norma/?category='20'");
			} );
				$(document).on("change",'#articletype',function(){
                    // Reload data based on choice
                    oTable.fnReloadAjax("../datatables_api/server_processing_norma/?category='20'&articletype="+$("#articletype option:selected").val());
                 });  
		</script>
				...
				?>
				<div class="span9"><a href="<?=$basedomain?>produk/addNorma" class="btn btn-primary"> Tambah Data</a></div>
				<?php
				}
				?>
				<div class="row-fluid">

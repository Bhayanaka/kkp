...
<a href="<?=$basedomain?>profil/struktur" class="sub_menu_in on">Struktur Organisasi</a>
<a href="<?=$basedomain?>profil/tupoksi" class="sub_menu_in">Tupoksi</a>
<br/>
<br/>
<h4 class="title_sub_menu_in">Struktur Organisasi</h4>
<div class="new_input">
	<form method="post" action="<?=$basedomain?>profil/input_struktur" enctype = "multipart/form-data">
		<table>
			<tr>
		...
		<p><b>Isi Struktur Organisasi :</b></p>
		...
		<input type="hidden" name="categoryid" id="categoryid"  value="<?=(isset($result[0]['categoryid']) ? $result[0]['categoryid'] : '2') ?>"/>

	...
	$(function(){
		...
		stepSecond:10});
				...
				<h4 class="title_sub_menu_in">Tambah RSS</h4>
				<div class="new_input">
					<form method="post" id="myform" action="<?=$basedomain?>rss/inputData" enctype="multipart/form-data">
					<table>
						<tr>
							<td>Judul RSS</td>
							<td>&nbsp;</td>
						...
						<tr>
							<td>Link RSS</td>
							<td>&nbsp;</td>
							<td><input type="text" name="link" id="" placeholder="https://www.google.co.id/" value="<?=(isset($data['result'][0]['brief']) ? $data['result'][0]['brief'] : '')?>" required="required">

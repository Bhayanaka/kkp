			...
			oSettings.fnServerData.call( oSettings.oInstance, oSettings.sAjaxSource, aData, function(json) {
				...
				$('#sigPolaTable').dataTable({
					...
					"bProcessing": true,
					"bServerSide": true,
					"sAjaxSource": "../datatables_api/server_processing_petaPolaRuang",
					...
					oTable= $('#sigPolaTable').dataTable();
					oTable.fnReloadAjax("../datatables_api/server_processing_petaPolaRuang/?category='33'");
			} );
				$(document).on("change",'#provinsi,#kabupaten,#type',function(){
					...
					oTable.fnReloadAjax("../datatables_api/server_processing_petaPolaRuang/?category='33' & provinsi=" + provinsi +"& kabupaten="+ kabupaten +"& type="+ type );
					...
					?>
					<div class="span4"><a href="<?=$basedomain?>sig/addpola" class="btn btn-primary"> Tambah Data</a></div>
					<?php
					}
					?>
				...
				<table class="table table-striped" id="sigPolaTable">
					<thead>
					<tr>
						<th>No</th>

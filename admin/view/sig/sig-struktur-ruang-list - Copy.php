					...
					?>	
						<div class="span2"><a href="<?=$basedomain?>sig/addpola_struktur" class="btn btn-primary"> Tambah Data</a></div>
					<?php
					}
					?>
					...
					<tr>
						...
						<td><?php
							...
							?>
								...
								<a	<a href="status/?id=<?php echo $val['id'];?>&status=<?php echo $val['n_status'];?>" class="icon-globe" title="Publish"></a>&nbsp;&nbsp;&nbsp;
								<a href="addpola_struktur/?id=<?php echo $val['id'];?>" class="icon-edit" title="Edit"></a>&nbsp;&nbsp;&nbsp; 
								<a href="del_pola_struktur/?id=<?php echo $val['id'];?>" class="icon-trash" title="Hapus" onclick="return confirm('Hapus Data');"></a>

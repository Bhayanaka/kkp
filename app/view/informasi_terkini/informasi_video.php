				...
				<div class="col-md-8">
					...
					<div class="tmb_box">
						...
						<a href="<?=$basedomain?>informasi_terkini/informasi_video_detail/?id=<?=$val['id']?>" >
							...
							<img src="<?=$basedomain?>assets/images/youtube.jpg?>" class="img-thumbnail tmb_height" >
							<!--<img src="<?=$basedomain?>public_assets/<?php echo $val['image']?>" class="img-thumbnail tmb_height" >-->
						</a>
					</div>

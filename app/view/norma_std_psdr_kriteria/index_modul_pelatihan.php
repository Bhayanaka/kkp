						...
						<div class="container-fluid">
							...
							<div class="col-md-8">
								...
								<ul class="breadcrumb" style="margin-bottom: 5px;">
								  ...
								  <li class="active">Modul Pelatihan</li>
								</ul>
								<h3 class="text-primary">Index Modul Pelatihan</h3>
								<hr/>
								
								<div class="form-group">
								<form action="<?=$basedomain.'norma_std_psdr_kriteria_c/modul_pelatihan/'?>" method="post">

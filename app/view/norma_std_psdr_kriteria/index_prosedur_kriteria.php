						...
						<div class="container-fluid">
							...
							<div class="col-md-8">
								...
								<ul class="breadcrumb" style="margin-bottom: 5px;">
								  ...
								  <li class="active">Prosedur dan Kriteria</li>
								</ul>
								<h3 class="text-primary">Index Prosedur dan Kriteria</h3>
								<hr/>
								
								<div class="form-group">
								<form action="<?=$basedomain.'norma_std_psdr_kriteria_c/prosedur_kriteria/'?>" method="post">

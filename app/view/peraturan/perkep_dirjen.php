						...
						<div class="container-fluid">
							<div class="col-md-8">
								...
								<ul class="breadcrumb" style="margin-bottom: 5px;">
								  ...
								  <li class="active">Peraturan / Keputusan Direktur Jenderal
</li>
								</ul>
								<h3 class="text-primary">Peraturan / Keputusan Direktur Jenderal
</h3>
								<hr/>
							<div class="form-group">
								  ...
								  <div class="input-group">
									...
									<input type="hidden" name="namakategori" value="Peraturan / Keputusan Direktur Jenderal" />

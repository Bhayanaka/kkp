						...
						<div class="container-fluid">
							<div class="col-md-8">
								...
								<ul class="breadcrumb" style="margin-bottom: 5px;">
								  ...
								  <li class="active"><?=$_POST['namakategori']?>
</li>
								</ul>
								<h3 class="text-primary"><?=$_POST['namakategori']?>
</h3>
								<hr/>
								<div class="form-group">
								  ...
								  <div class="input-group">
									...
									<input type="text" class="form-control" name="title" placeholder="Kata Kunci"><input type="hidden" name="kategori" value="<?=$_POST['kategori']?>" />
									<input type="hidden" name="namakategori" value="<?=$_POST['namakategori']?>" />

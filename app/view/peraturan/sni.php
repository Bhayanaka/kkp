						...
						<div class="container-fluid">
							<div class="col-md-8">
								...
								<ul class="breadcrumb" style="margin-bottom: 5px;">
								  ...
								  <li class="active">Standar Nasional Indonesia
</li>
								</ul>
								<h3 class="text-primary">Standar Nasional Indonesia
</h3>
								<hr/>
								...
								<div class="form-group">
								  ...
								  <div class="input-group">
									...
									<input type="hidden" name="namakategori" value="Standar Nasional Indonesia" />

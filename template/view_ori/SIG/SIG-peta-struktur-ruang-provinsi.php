...
*/		
	...
	$title_page=array('Aplikasi','SIG Pengelolaan Pesisir dan Pulau - Pulau Kecil','Peta Struktur Ruang','Provinsi');
...
?>
		<div class="row-fluid ">
			...
			<div class="span10 bg_putih body">
				<div class="row-fluid">
				  <div class="span8">
						<h3>Peta Struktur Ruang - Provinsi</h3>
						<form method="post" action="<?=$basedomain?>minapolitan/searchSigStruktur" class="form-inline" >
							<div class="controls">
								...
								<input class="" type="hidden" name="type" value="2">&nbsp;	

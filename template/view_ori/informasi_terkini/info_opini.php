...
*/		
	...
	$title_page=array('Informasi TRLP-3-K','Opini','List Opini');
	$link_title_page=array('#','#','#');
						...
						<div class="row-fluid">
							 <div class="span3">
							  ...
							  <div class="span9">
								...
								<p>	
									<?=$val['brief']?>
									&nbsp;<a href="<?=$basedomain?>berita/info_opini_detail/?id=<?=$val['id']?>" ><i><small>Selengkapnya</small></i></a>
								</p>
							 </div>
						</div>
						<?php

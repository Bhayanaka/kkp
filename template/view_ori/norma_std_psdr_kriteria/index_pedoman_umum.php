...
*/		
	...
	$title_page=array('Produk','Norma, Standart, Prosedur dan Kriteria','Pedoman Umum');
...
?>
		<div class="row-fluid ">
			...
			<div class="span10 bg_putih body">
				<div class="row-fluid">
				  <div class="span8">
						<h3>Produk - Pedoman Umum</h3>
						
						<form action="<?=$basedomain.'norma_std_psdr_kriteria_c/pedoman_umum/'?>" method="post" class="form-inline" >
							<div class="controls">
						...
						?>
							...
							<tr>
								...
								<td>
									...
									<p><a class="btn btn-mini btn-success fancybox" rel="group"  href="<?=$basedomain?>public_assets/norma/<?php echo $files;?>"><?= $value['thumbnail'];?>&nbsp;<i class=" icon-arrow-down icon-white"></i></a></p>

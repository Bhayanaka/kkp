...
*/		
	...
	$link_menu=array('Produk','Program','Aplikasi');
	//sub_top_menu('bg_ungu','m4',$title_menu,$link_menu);
	sub_top_menu('bg_ungu');
	
	$title_page=array('Produk','Norma, Standart, Prosedur dan Kriteria','Prosedur dan Kriteria');
...
?>
		<div class="row-fluid ">
			...
			<div class="span10 bg_putih body">
				<div class="row-fluid">
				  <div class="span8">
						<h3>Produk - Prosedur dan Kriteria</h3>
						
						<form action="<?=$basedomain.'norma_std_psdr_kriteria_c/prosedur_kriteria/'?>" method="post" class="form-inline">
							<div class="controls">

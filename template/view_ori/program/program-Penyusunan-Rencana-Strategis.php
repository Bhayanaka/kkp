...
*/		
	...
	$title_page=array('Produk','Penyusunan Rencana Strategis WP-3-K');
...
?>
		<div class="row-fluid ">
			...
			<div class="span10 bg_putih body">
				<div class="row-fluid">
				  <div class="span8">
						<h3>Program - Penyusunan Rencana Strategis WP-3-K</h3>
						...
						<form method="post" action="<?=$basedomain?>program/searchProgram" class="form-inline" >
							<div class="controls">
								...
								<input class="span10" type="hidden" name="type" value="1">&nbsp;	
